...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <link rel="icon" href="images/Logggo.jpg" type="image/x-icon">
    ...
    <div class="preloader">
      <div class="preloader-logo"><a class="brand" href="index.php"><img class="brand-logo-dark" src="images/Logggo.jpg" alt="" width="245" height="50"/><img class="brand-logo-light" src="images/logo-inverse-245x50.png" alt="" width="245" height="50"/></a>
      </div>
      <div class="preloader-body">
        <div class="cssload-containerr">
            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a class="brand" href="index.php"><img class="brand-logo-dark" src="images/Logggo.jpg" alt="" width="245" height="50"/><img class="brand-logo-light" src="images/logo-inverse-245x50.png" alt="" width="245" height="50"/></a>
                  </div>
                </div>
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item"><a class="rd-nav-link" href="mapa.php" >Buscar Carreras </a> 
                    </li>
                    <li class="rd-nav-item"><a class="rd-nav-link" href="contactos.php">Contáctanos</a>
                    </li>
                    <li class="rd-nav-item"><a class="rd-nav-link" href="../gestion">INICIA SESIÓN</a>
                    </li>
                  </ul>
                </div>
              </div>
    ...
    <body>
            ...
            <div class="containerr">
              <div class="row row-50 justify-content-center justify-content-xl-between flex-lg-row-reverse">
                ...
                <div class="row row-30">
                  <div class="col-md-6"><img class="img-responsive rounded" src="images/costa-rica.png" alt=""
                      width="340" height="250" />
                  </div>
                  <div class="col-md-11 col-lg-6 col-xl-5">
                    <div class="box-1">
                      <h2>Conoce Las Parauniversitarias Según Tu Provincia</h2>
                      <h5>¡Bienvenido a Encuentra Tu Carrera CR!</h5>
                      <p> </p><a class="button button-lg button-primary-gradient" href="#"><span>Da click en Tú Provincia</span></a>
                    </div>
        ...
        <div id="mapa">
            <img src="img/transparente.png" alt="Mapa provincial de Costa Rica" border="0" usemap="#Map" class="costarican"/>
            <map name="Map" id="Map" alt="Mapa provincial de Costa Rica" class="mapa">
                <area shape="poly" coords="107,207,94,225,85,203,91,174,101,149,122,134,123,117,121,95,85,78,84,67,100,68,116,59,119,44,122,25,133,11,154,24,174,28,198,38,177,53,160,66,176,88,198,102,217,104,238,111,151,130,271,141,289,158,286,182,272,199,264,217,246,215,225,216,208,212,195,205,200,226,210,249,194,255,192,271,210,284,200,299,182,285,162,276,141,275,121,267" href="javascript:," class="guanacaste" alt=" Guanacaste" title="Guanacaste"/>
                <area shape="poly" coords="414,253,418,233,419,213,420,190,420,169,420,146,419,126,420,106,436,101,457,111,477,109,495,98,484,113,471,131,476,148,466,168,456,204,443,212,426,217,436,238,428,252" href="javascript:," class="heredia" alt=" Heredia" title="Heredia"/>
                <area shape="poly" coords="440,293,451,271,466,266,478,248,478,236,498,246,519,256,542,260,561,259,571,269,569,290,556,310,542,328,531,341,512,335,492,327,475,313,458,301" href="javascript:," class="cartago" alt=" Cartago" title="Cartago"/>
                <area shape="poly" coords="463,219,477,200,479,179,481,160,483,138,488,118,507,113,507,95,514,78,522,76,518,91,528,107,536,125,546,149,557,167,571,187,587,207,604,228,621,250,639,259,654,284,670,303,685,316,710,328,723,339,710,347,693,332,672,330,671,350,656,360,655,381,655,402,656,422,647,422,635,406,615,388,594,381,574,380,556,370,547,346,552,326,566,307,581,287,579,268,577,252,556,252,536,252,516,246,496,236,462,219" href="javascript:," class="limon" alt=" Limón" title="Limón"/>
                <area shape="poly" coords="209,305,215,285,204,265,218,253,239,262,261,270,262,282,264,292,254,303,247,303,235,319,223,334,211,313,209,305,246,223,265,229,277,212,277,189,294,197,311,196,312,221,323,242,324,258,312,275,330,285,327,301,333,324,346,339,367,335,383,325,403,331,420,340,433,352,451,370,468,381,479,400,499,408,512,422,532,436,553,429,547,407,557,387,576,385,596,387,615,394,631,411,644,426,661,440,681,448,698,463,682,476,661,510,676,526,677,547,666,565,648,576,639,590,659,601,665,622,668,642,662,627,652,607,632,591,624,573,623,549,621,531,599,525,583,514,565,505,548,515,562,534,582,546,588,566,577,574,557,564,537,563,517,546,503,527,519,514,532,495,531,476,537,456,514,438,498,421,480,407,460,390,440,380,420,374,405,357,384,357,364,346,344,345,325,333,316,313,321,292,305,271,294,255,272,248,253,232,237,219,246,224" href="javascript:," class="puntarenas" alt=" Puntarenas" title="Puntarenas"/>
                <area shape="poly" coords="267,65,287,54,307,42,327,43,347,49,368,59,386,69,402,81,412,97,411,161,410,223,410,243,400,260,378,264,358,265,339,276,320,276,332,259,334,244,320,228,320,207,310,192,297,184,299,163,283,142,261,130,249,110,229,103,209,93,187,82,165,68,185,56,203,42,223,45,246,56,269,66" href="javascript:," class="alajuela" alt=" Alajuela" title="Alajuela"/>
                <area shape="poly" coords="336,286,354,271,376,270,399,266,418,264,440,257,445,238,440,221,456,221,465,239,466,258,444,263,440,280,432,302,450,304,470,322,467,334,506,347,525,346,546,357,554,377,545,398,548,421,534,432,514,415,499,402,481,394,471,377,455,366,437,342,418,327,398,323,376,320,359,333,339,334,335,315,337,286" href="javascript:," class="san_jose" alt=" San José" title="San José"/>
            </map>
        </div>
        <div id="listadoProvincias">
            <ul>
                <li>
                    <a href="javascript:;" class="alajuela">Alajuela</a>
                </li>
                <li>
                    <a href="javascript:;" class="cartago">Cartago</a>
                </li>
                <li>
                    <a href="javascript:;" class="guanacaste">Guanacaste</a>
                </li>
                <li>
                    <a href="javascript:;" class="heredia">Heredia</a>
                </li>
                <li>
                    <a href="javascript:;" class="limon">Limón</a>
                </li>
                <li>
                    <a href="javascript:;" class="puntarenas">Puntarenas</a>
                </li>
                <li>
                    <a href="javascript:;" class="san_jose">San José</a>
                </li>
            </ul>
        </div>
        ...
        <div class="containerr">
          ...
          <div class="tabs-custom tabs-horizontal tabs-corporate" id="tabs-1">
            ...
            <ul class="nav nav-tabs">
              <li class="nav-item" role="presentation"><a class="nav-link active" href="#tabs-1-1" data-toggle="tab"><span class="nav-link-main">Alajuela</span></a></li>
              <li class="nav-item" role="presentation"><a  class="nav-link" href="#tabs-1-2" data-toggle="tab"><span class="nav-link-main">Cartago</span></a></li>
              <li class="nav-item" role="presentation"><a  class="nav-link" href="#tabs-1-3" data-toggle="tab"><span class="nav-link-main">Guanacaste</span></a></li>
              <li class="nav-item" role="presentation"><a  class="nav-link" href="#tabs-1-4" data-toggle="tab"><span class="nav-link-main">Heredia</span></a></li>
              <li class="nav-item" role="presentation"><a  class="nav-link" href="#tabs-1-5" data-toggle="tab"><span class="nav-link-main">Limón</span></a></li>
              <li class="nav-item" role="presentation"><a  class="nav-link" href="#tabs-1-6" data-toggle="tab"><span class="nav-link-main">Puntarenas</span></a></li>
              <li class="nav-item" role="presentation"><a  class="nav-link" href="#tabs-1-7" data-toggle="tab"><span class="nav-link-main">San José</span></a></li>
            </ul>
            <!-- Tab panes-->
            <div class="tab-content">
              <div class="tab-pane fade show active" id="tabs-1-1">
                <div class="tabs-custom tabs-horizontal tabs-gallery hide-on-modal" id="tabs-galery">
                  <!-- Nav tabs-->
                  <ul class="nav nav-tabs">
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-gallery-1" data-toggle="tab"><img src="images/gallery-01-180x180.jpg" alt="" width="180" height="180"/><span>Hola</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-gallery-2" data-toggle="tab"><img src="images/gallery-02-180x180.jpg" alt="" width="180" height="180"/><span>Hola</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-gallery-3" data-toggle="tab"><img src="images/gallery-03-180x180.jpg" alt="" width="180" height="180"/><span>Hola</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-gallery-4" data-toggle="tab"><img src="images/gallery-04-180x180.jpg" alt="" width="180" height="180"/><span>Hola</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-gallery-5" data-toggle="tab"><img src="images/gallery-05-180x180.jpg" alt="" width="180" height="180"/><span>Hola</span></a></li>
                  </ul>
                  <!-- Tab panes-->
                  <div class="tab-content">
              ...
              <div class="tab-pane fade" id="tabs-1-3">
                <div class="content-box hide-on-modal">
                  <div class="content-box-inner row-30">
                    <h3>Universidades De Guanacaste</h3>
                    <div class="row align-items-center row-30">
                      <div class="col-12 col-md-6">
                        <div class="unit service-box">
                          ...
                          <div class="unit-body"><a class="subtitle" href="#" data-toggle="modal" data-target="#modal-service-1">Datebayo</a>
                            <p>Datebayo</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6">
                        <div class="unit service-box">
                          ...
                          <div class="unit-body"><a class="subtitle" href="#" data-toggle="modal" data-target="#modal-service-2">Datebayo 2</a>
                            <p> Datebayo 2</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6">
                        <div class="unit service-box">
                          ...
                          <div class="unit-body"><a class="subtitle" href="#" data-toggle="modal" data-target="#modal-service-3">Datebayo 3</a>
                            <p>Datebayo 3</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6">
                        <div class="unit service-box">
                          ...
                          <div class="unit-body"><a class="subtitle" href="#" data-toggle="modal" data-target="#modal-service-4">Datebayo 4</a>
                            <p>Datebayo 4</p>
                          </div>
                        </div>
                      </div>
