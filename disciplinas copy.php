...
<section class="section section-lg bg-gray-100">
        <div class="container">
          <div class="row row-50 justify-content-center justify-content-lg-between">
            <div class="col-12">
              <h3 class="h-custom-1 f1">Adéntrate en el Universo de las Carreras Profesionales Explorando Opciones por Áreas de Estudio.</h3>
            </div>
            <div class="col-md-6 col-lg-5 col-xl-3 wow fadeIn">
            <img class="img-rounded" src="images/universidad.png" alt="">
            </div>
            <div class="col-md-6 col-xl-3 wow fadeIn" data-wow-delay=".2s">
            <img class="img-rounded" src="images/book.png" alt="">

            </div>
            <div class="col-md-6 col-xl-3 wow fadeIn" data-wow-delay=".2s">
            <img class="img-rounded" src="images/graduated.png" alt="">
      ...
      <section class="section section-sm section-fluid bg-default text-center" id="projects">
        <div class="container-fluid">
          <h2 class="wow fadeInLeft">Artes Letras y Filosofía</h2>
          ...
          <div class="isotope-filters isotope-filters-horizontal">
            ...
            <ul class="isotope-filters-list" id="isotope-3">
              ...
              <li><a href="#" data-isotope-filter="Type 1" data-isotope-group="gallery">Arte y Letras</a></li>
              <li><a href="#" data-isotope-filter="Type 2" data-isotope-group="gallery">Arte Publicitario</a></li>
              <li><a href="#" data-isotope-filter="Type 3" data-isotope-group="gallery">Lenguas</a></li>
            </ul>
          </div>
